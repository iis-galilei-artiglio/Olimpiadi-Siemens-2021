...
Le informazioni che la rete neurale comunica al PLC sono sostanzialmente tre: la coordinata x e la coordinata y per la localizzazione del pezzo sul piano e l'area del box di riconoscimento per comunicare la profondità, ovvero l'asse z. Infatti all'avvicinarsi della webcam al relè, il box che delimita l'oggetto riconosciuto aumenta e con esso l'area. Tra i vari studi condotti con il robot, uno in particolare è stato quello di capire se era possibile utilizzare la sola rete neurale come unico sensore. Questa possibilità oltre ad emulare il comportamento umano semplifica la costruzione del robot portando ad un risparmio economico in termini di componentistica e di conseguenza minori guasti e minore manutenzione.  
