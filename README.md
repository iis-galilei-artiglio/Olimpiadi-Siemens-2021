...
Il pittogramma può essere una valida alternativa al servizio [Google Api developer](https://console.developers.google.com) in cui è possibile realizzare un progetto di Cluod Vision API per il riconoscimento delle terghe di autoveicoli. 
